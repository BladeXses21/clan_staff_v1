...
from config import (
    PREFIX, STATS_CHAT, HATORY_CATEGORY_NAME, 
    TENDERLY_CATEGORY, META_CATEGORY, SWEETNESS_ID, 
    SWEETNESS_CATEGORY_NAME, SERVER_EMOGI, TENDERLY_CATEGORY_NAME, 
    META_CATEGORY_NAME, TENDERLY_ID, META_ID, 
    DARKNESS_ID, HATORY_ID, DARKNESS_CATEGORY_NAME
)
...
class ClanStats(BaseCog):
    ...
    async def servers_clans_stats(self):
        ...
        await self.stats_chat.send(embed=BaseEmbed(
