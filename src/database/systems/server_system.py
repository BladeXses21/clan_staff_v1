from src.database.models import CrossGuildModel
...
class CrossServerSystem(DatabaseSystem):
    ...
    def add_guild(self, guild_id: int, event_channel_id: int, text_category_id: int,
                    voice_category_id: int, clan_staff_role_id: int,
                    auction_channel_id: int, trash_channel_id: int,
                    leader_role_id: int, consliger_role_id: int,
                    find_clan_channel_id: int, clan_info_channel_id: int,
                    create_clan_url: str, verify_url: str, clan_staff_url: str,
                    team_lead_id: int, senior_lead_id: int) -> bool:
        cgm = CrossGuildModel(
