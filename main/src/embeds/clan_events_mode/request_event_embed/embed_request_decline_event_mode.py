...
async def decline_event_embed(user, request_msg, clan_name, event_num, clan_staff, decline_view):
    try:
        ...
        await request_msg.edit(
            embed=RequestDeclineEventMode(clan_name=clan_name, event_num=event_num, event_mode=clan_staff.name).embed, view=decline_view)
