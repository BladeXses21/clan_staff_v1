...
from config import PREFIX, TENDERLY_ID, AUCTION_TENDERLY_IMAGE, META_ID, DARKNESS_ID, AUCTION_DARKNESS_IMAGE, AUCTION_META_IMAGE, HATORY_ID


class AuctionStartEmbed(object):
    def __init__(self, clan, amount, guild):
        self._embed = Embed(title="<:auction_lot:973729039846088734> Клановый аукцион",
