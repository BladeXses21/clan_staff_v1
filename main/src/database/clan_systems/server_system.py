...
class CrossServerSystem(DatabaseSystem):
    ...
    def add_guild(self, guild_id: int, event_channel_id: int, text_category_id: int,
                  ...
                  leader_role_id: int, consigliere_role_id: int, find_clan_channel_id: int, clan_info_channel_id: int,
                  create_clan_url: str, verify_url: str, clan_staff_url: str, team_lead_id: int,
                  senior_lead_id: int) -> bool:
        ...
        cgm.consigliere_role_id = consigliere_role_id
    ...
    def get_help_fields(self, guild_id: int) -> tuple[
        srv_modal.leader_role_id, srv_modal.consigliere_role_id, srv_modal.find_clan_channel_id, srv_modal.clan_info_channel_id,
        ...
        return res['leader_role_id'], res['consliger_role_id'], res['find_clan_channel_id'], res[
            'clan_info_channel_id'], res['create_clan_url'], res['verify_url'], res['clan_staff_url'], \
    ...
    def get_cross_guild(self, guild_id: int) -> tuple[
        srv_modal.event_channel_id, srv_modal.clan_staff_role_id, srv_modal.text_category_id, srv_modal.voice_category_id]:
        cgm = CrossGuildModel(guild_id=guild_id)
        res = self.cross_guild_collection.find_one(cgm.to_mongo())
